      ...
      >
        <div className="h-full flex flex-col justify-start md:justify-center items-center">
          ...
          <div className="flex  sm:pt-10">
            <div>
              <svg
                ...
                className="icon icon-tabler icon-tabler-brand-discord-filled text-white cursor-pointer mx-6 transition-all ease-in-out duration-300 hover:scale-125"
                width="36"
                height="36"
                viewBox="0 0 24 24"
                strokeWidth="1.5"
            ...
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="icon icon-tabler icon-tabler-brand-x cursor-pointer mx-6 transition-all ease-in-out duration-300 hover:scale-125"
                width="36"
                height="36"
                viewBox="0 0 24 24"
                strokeWidth="1.5"
            ...
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="icon icon-tabler icon-tabler-brand-facebook-filled  text-white cursor-pointer mx-6 transition-all ease-in-out duration-300 hover:scale-125"
                width="36"
                height="36"
                viewBox="0 0 24 24"
                strokeWidth="1.5"
            ...
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="icon icon-tabler icon-tabler-brand-youtube-filled  text-white cursor-pointer mx-6 transition-all ease-in-out duration-300 hover:scale-125"
                width="36"
                height="36"
                viewBox="0 0 24 24"
                strokeWidth="1.5"
          ...
          <div className="flex items-center justify-center pt-5">
            <p className="text-white w-24 text-center hover:text-lime-400 text-sm">
              Privacy
            </p>
            <p className="text-white w-24 text-center hover:text-lime-400 text-sm">
              Terms of Use
